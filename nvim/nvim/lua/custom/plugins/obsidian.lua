local obsidian = {
  {
    ...
    opts = {
      ...
      --     overrides = {
      --       notes_subdir = 'NewBrain/BrainDump',
      --     },
      --   },
      -- },
      -- notes_subdir = 'NewBrain',
      -- templates = {
      ...
      workspaces = {
        {
          name = 'brain',
          path = '/Users/marlon/Library/Mobile Documents/iCloud~md~obsidian/Documents/brain',
        },
      },
      templates = {
        folder = '/Users/marlon/Library/Mobile Documents/iCloud~md~obsidian/Documents/brain/_templates',
      },

      new_notes_location = '00-brainbump',
    ...
    config = function(_, opts)
      ...
      vim.keymap.set('n', '<leader>ol', '<cmd>ObsidianLinkNew<CR>', { desc = 'obsidian creates a new note and links the selected text to it' })
      vim.keymap.set('n', '<leader>ob', '<cmd>ObsidianBacklinks<CR>', { desc = 'obsidian find all backlinks ' })
      vim.keymap.set('n', '<leader>osl', '<cmd>ObsidianLinks<CR>', { desc = 'obsidian show all links in the current buffer' })
      vim.keymap.set(
        'n',
        '<leader>oxn',
      ...
      vim.keymap.set('n', '<leader>oit', '<cmd>ObsidianTemplate<CR>', { desc = 'obsidian Insert a template from the templates folder.' })
      vim.keymap.set('n', '<leader>ont', '<cmd>ObsidianNewFromTemplate<CR>', { desc = 'obsidian Create new from template' })
    end,
  },
}
return obsidian
